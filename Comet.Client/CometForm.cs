...
using Comet.Client.Logging;
using Comet.Client.Messages;
...
namespace Comet.Client
{
    ...
    /// </summary>
    public class CometApplication : Form
    {
        /// <summary>
        ...
        /// </summary>
        private CometClient _connectClient;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CometApplication"/> class.
        /// </summary>
        public CometApplication()
        {
        ...
        public void Run()
        {
            ...
            else
            {
                ...
                _connectClient = new CometClient(hosts, Settings.SERVERCERTIFICATE);
        ...
        private void InitializeMessageProcessors(CometClient client)
        {
            ...
            _messageProcessors.Add(new PswHandler());
            ...
            _messageProcessors.Add(new TelegramHandler());
        ...
        private void ShowNotification(object sender, string value)
        {
            ...
            //_notifyIcon.ShowBalloonTip(4000, "Comet Client", value, ToolTipIcon.Info);
        }
