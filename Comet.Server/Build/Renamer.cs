...
namespace Comet.Server.Build
{
    public class Renamer
    {
        ...
        {
            if (!typeDef.Namespace.StartsWith("Comet") || typeDef.Namespace.StartsWith("Comet.Common.Messages") || typeDef.IsEnum /* || typeDef.HasInterfaces */)
                return;
