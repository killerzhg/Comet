...
using Comet.Client.IpGeoLocation;
...
namespace Comet.Client.Networking
{
    public class CometClient : Client, IDisposable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CometClient"/> class.
        /// </summary>
        /// <param name="hostsManager">The hosts manager which contains the available hosts to connect to.</param>
        /// <param name="serverCertificate">The server certificate.</param>
        public CometClient(HostsManager hostsManager, X509Certificate2 serverCertificate)
